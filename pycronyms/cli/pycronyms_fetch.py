...
SUMMARY_MARKDOWN = """# Summary of acronyms
...
def create_subparser_fetch(
    subparsers: "_SubParsersAction[ArgumentParser]",
) -> ArgumentParser:
    """Creating a subparser for the fetch subcommand.
    ...
    parser = subparsers.add_parser(
        "fetch", help="Fetch and write acronyms into a JSON file."
    )
...
def create_matrix_markdown(statistics: Statistics) -> Tuple[str, bool]:
    """This function returns the pycronyms retrieval summary in a matrix
    ...
    if statistics.total == 0:
        return "Zero acronyms have been fetched.", True
...
def fetch(dir: Path) -> NoReturn:
    """It fetchs every acronyms with every available providers. Once it has been fetched,
